      ...
      new ExercisePlan(
        new Exercise(
          ...
          `Stand with your head facing forward and your chest held up and out.<br>
              ...
              Sit back and down like you're sitting into a chair. Keep your head facing straight as your upper body bends forward a bit.<br>
              Rather than allowing your back to round, let your lower back arch slightly as you go down.<br>
    ...
    workout.exercises.push(
      new ExercisePlan(
        new Exercise(
          ...
          'tricepdips.png',
          'tricepdips.wav',
          `Sit up on a chair. <br>
          Your legs should be slightly extended, with your feet flat on the floor.<br>
          Place your hands edges of the chair. <br>
          Your palms should be down, fingertips pointing towards the floor.<br>
          Without moving your legs, bring your glutes forward off the chair.<br>
          Steadily lower yourself. <br>
          When your elbows form 90 degrees angles, push yourself back up to starting position.`,
    ...
    workout.exercises.push(
      new ExercisePlan(
        new Exercise(
          ...
          Keep your hips square and your neck in line with your spine.<br>
          Hold the position.`,
